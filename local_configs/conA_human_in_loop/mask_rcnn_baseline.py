...
classes = ('cell',)
data_root = "/mnt/zihanwu/wentaopan/cell_instance_segmentation/data/conA"
train_set = '/mnt/zihanwu/wentaopan/cell_instance_segmentation/data/conA/train_1.json'
val_set = '/mnt/zihanwu/wentaopan/cell_instance_segmentation/data/conA/val.json'
data = dict(
...
work_dir="/mnt/zihanwu/wentaopan/cell_instance_segmentation/work_dir/conA_human_loop/baseline_110_130_500"
